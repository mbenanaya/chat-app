...
// import { BsTel } from "react-icons/bs";

export default function ChatSidebar({ users }) {
    return (
        <>
            <div className="search_box h-10 bg-gray-800 text-slate-300">
                <div className="flex justify-between items-center px-5 pb-1 border-r border-slate-100">
                    <form className="flex items-center">
                        ...
                        <input
                            type="search"
                            placeholder="Search..."
                            className="text-gray-300 bg-gray-800 border-0 hover:border-0 focus:border-0 focus:outline-none shadow-none focus:ring-0"
                        />
                    </form>
                    <div>
                        <button>
                ...
                <div className="user_list oveflow-y-auto h-screen">
                    {users.map((user, index) => (
                        <Link
                            ...
                            key={index}
                            className="flex transition px-5 py-3 hover:bg-gray-600 hover:cursor-pointer"
                        >
                            <div className="pr-4">
                                <img
                                    src={Admin}
